      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/6 bg-[#050505]/90 backdrop-blur-md">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between gap-4 max-w-6xl">
          ...
          <div className="flex items-center gap-7">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm font-semibold text-white/40">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="md:hidden w-9 h-9 flex items-center justify-center rounded-lg bg-white/6 border border-white/8"
            >
        ...
        {/* Mobile menu */}
        {mobileOpen && (
          <div className="md:hidden border-t border-white/6 bg-[#080808] px-4 py-4 flex flex-col gap-3">
            ...
            <Link href="/products" onClick={() => setMobileOpen(false)} className="text-sm font-semibold text-white/60 hover:text-white py-1">Products</Link>
            {categories.slice(0, 6).map((c) => (
              <Link key={c.id} href={`/category/${c.slug}`} onClick={() => setMobileOpen(false)} className="text-sm font-semibold text-white/60 hover:text-white py-1">
                {c.name}
              </Link>
            ))}
          </div>
